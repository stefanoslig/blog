  ...
  return (
    <div className="flex mt-6 flex-col pb-9">
      ...
      {type === LongStoryShortEnum.SHORT ? (
        ...
        <>
          <p className="text-lg text-slate-600">
            Hi! Since you&apos;re here it means you want to learn more about me.
            That&apos;s a little bit awkward to be honest but it&apos;s fine.
            Feel free to check my Github/Medium accounts (links{" "}
          ...
          <p className="text-lg text-slate-600">
            ...
            (NgRx, RxJS, tailwind, storybook, nrwl/nx, etc). I started working
            with the new version of Angular back in 2016 (beta.6) and I
            haven&apos;t stopped using it yet. However, I wouldn&apos;t say
            no to other frameworks. I really enjoy React and its simplicity,
            compared to Angular of course ;-) This blog is actually built with
            React and Next.js.
          </p>
          <br />
          <p className="text-lg text-slate-600">
